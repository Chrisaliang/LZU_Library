...
public class HallNotifyActivity extends BaseActivity {
    ...
    protected View fillLayout() {
        View view = UIUtils.inflate(R.layout.activity_hall_notify);
        webView = (WebView) view.findViewById(R.id.web_view_tzgg);
        initWebView();

        webView.loadUrl(HttpUrl.HALLNOTIFY);
        return view;
    }
    ...
    public CharSequence setActivityTitle() {
        return getString(R.string.hall_notify);
    }
}

...
public class NavigationFragment extends BaseFragment {
    ...
    protected View onSubCreateSuccessView() {
        LinearLayout view = (LinearLayout) UIUtils.inflate(R.layout.layout_fragment_navigation);
        webView = (WebView) view.findViewById(R.id.wb_fg_nav);
        initWebView();

        webView.loadUrl(HttpUrl.LZULIBRARYHOME);
        return view;
    }

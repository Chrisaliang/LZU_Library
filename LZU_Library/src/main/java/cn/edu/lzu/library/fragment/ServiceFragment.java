...
public class ServiceFragment extends BaseFragment {
    ...
    protected View onSubCreateSuccessView() {
        LinearLayout view = (LinearLayout) UIUtils.inflate(R.layout.layout_fragment_service);
        webView = (WebView) view.findViewById(R.id.wb_service);
        initWebView();

        webView.loadUrl(HttpUrl.SERVICE);
        return view;
    }
